...
# BUILD docker build -f dockerfiles/analysis-java-8.Dockerfile -t  buildableprojects/analysis_process:java-8 .
# RUN   docker run -it -p 8888:8888 buildableprojects/analysis_process:java-8
